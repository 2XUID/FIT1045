...
class SocialNetwork:
    ...
    def __init__(self,people_friendship_data,post_history):
        ...
        '''
        #initialise the SocialNetwork class instance and assign values to the attributes people and posts
        self.people={}
        self.posts=[]
        ...
        for each_line in people_friendship_data:
            ...
            for each_person in each_relationship:
                ...
                #info_name is the name of their person and is always the first element of the broken list
                ...
                #adding the info_name to the temp_name_ls
    ...
    def make_birthday_posts(self,from_person_id,comparison_date):
        ...
        for friends_id in bday_friends:
            #create a content string including what will be said in the post
