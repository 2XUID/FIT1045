...
def new_post(content,owner,tagged):
    ...
    This function takes:
        ...
        - tagged which is a list of integers that specify the id's of the people tagged in this post
...
def birthdays_within_a_week_of(person_id,people_dict,comparison):
    ...
    for friends_id in friends_list:
        ...
        #thi is done by running the funciton birthday_within_X_days_of_Y() and testing if the return value is true
